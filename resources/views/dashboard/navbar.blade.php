        ...
        <ul class="flex h-full w-full items-center justify-center">
         ...
         <li class="h-25">
           <div class="flex h-25 px-4 border-b-4 text-white border-teknik  items-center hover:ease-in-out hover:duration-300">
               <a href="/login" class="px-4 py-4 rounded-md bg-amber-600 hover:bg-blue-500 text-center flex items-center font-bold hover:font-extrabold text-sm">LOGIN ADMIN</a>
           </div>
         </li>
        </ul>
      </div>
