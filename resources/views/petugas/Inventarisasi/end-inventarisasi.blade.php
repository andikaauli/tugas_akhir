    ...
    <div class="mt-18">
        ...
        <div class="py-3 px-4 bg-blue-100">
            <div class="p-4 bg-green-500">
                <p class="text-white">Anda yakin mengakhiri proses inventarisasi? Setelah diakhiri Anda tidak bisa
                    mengubah kembali data inventarisasi</p>
            </div>
        </div>
        {{-- End Section 2 --}}
        {{-- Section 2 --}}
