...
<div class="mt-18 ml-64">
   ...
   {{-- End Section 1 --}}
   {{-- Section 2 --}}
    <form action="{{ route('client.loan', ['id' => $members->id]) }}">
    @method('PUT')
    @csrf
        ...
        <div class="grid grid-cols-2 gap-0">
           ...
           <div class="">
              ...
              <div class="flex border-b border-gray-200">
                 ...
                 <div class="font-normal text-sm px-4 py-3">
                    <p>{{ \Carbon\Carbon::createFromTimestamp(strtotime($members->created_at))->format('d F Y') }}</p>
                 </div>
              </div>
           </div>
        </div>
         ...
         <div class="content_box">
           <div class="content hidden bg-white animate-move duration-500 p-5 actived">
             ...
             <div class="flex items-center p-4">
                 ...
                 {{-- Btn Search --}}
                 <button type="submit" class="px-3 h-10 rounded bg-gray-500 text-white text-sm font-semibold hover:bg-blue-500">Pinjam</button>
                 {{-- End Btn Search --}}
             </div>
             {{-- End Search Bar --}}
