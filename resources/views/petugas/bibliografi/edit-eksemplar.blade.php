         ...
         {{-- Judul --}}
             <div class="flex border-y border-solid border-gray-300">
                 ...
                 <div class="flex flex-auto items-stretch px-4 py-3">
                     <p class="text-sm font-medium">PostgreSQL : a comprehensive guide to building, programming, and administering PostgreSQL databases</p>
                 </div>
             </div>
         {{-- End Judul --}}
             {{-- Kode RFID --}}
                 <div class="flex border-b border-gray-300">
                     ...
                     <div class="px-4 py-3 text-sm">
                      ...
                      <div class="px-4 py-3">
                         <input type="text" id="small-input" value="{{ $eksemplar->rfid_code}}" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
                     </div>
                 </div>
             {{-- End Kode RFID --}}
             {{-- Kode Eksemplar --}}
                 <div class="flex border-b border-gray-300">
                     ...
                     <div class="px-4 py-3 text-sm">
                      ...
                      <div class="px-4 py-3">
                         <input type="text" id="small-input" value="{{ $eksemplar->item_code}}" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
                     </div>
                 </div>
             {{-- End Kode Eksemplar --}}
             {{-- No. Panggil --}}
             ...
             {{-- No. Pemesanan --}}
                 <div class="flex border-b border-gray-300">
                     ...
                     <div class="px-4 py-3 text-sm">
                      ...
                      <div class="px-4 py-3">
                         <input type="text" id="small-input" value="{{ $eksemplar->order_number}}" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
                     </div>
                 </div>
             {{-- End No. Pemesanan --}}
             {{-- Tanggal Pemesanan --}}
             ...
             {{-- Faktur --}}
                 <div class="flex border-b border-gray-300">
                     ...
                     <div class="px-4 py-3 text-sm">
                      ...
                      <div class="px-4 py-3">
                         <input type="text" id="small-input" value="{{ $eksemplar->invoice}}" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
                     </div>
                 </div>
             {{-- End Faktur --}}
             {{-- Harga --}}
                 <div class="flex border-b border-gray-300">
                     ...
                     <div class="px-4 py-3 text-sm">
                      ...
                      <div class="px-4 py-3">
                         <input type="text" id="small-input" value="{{ $eksemplar->price}}" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
                     </div>
                 </div>
             {{-- End Harga --}}
             </div>
