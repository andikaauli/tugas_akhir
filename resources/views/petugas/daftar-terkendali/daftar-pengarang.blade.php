...
@section('active-pengarang', 'bg-white bg-opacity-30')
...
<div class="sm:ml-64">
    <div class="mt-18">
        ...
        {{-- End Section 2 --}}
        {{-- Section 3 --}}
        <form action="{{ route('client.delete-authors') }}" method="POST">
            @csrf
            @method('DELETE')
                            ...
                            <tr class="border-b border-solid border-gray-400">
                                <td class="p-3 w-16">
                                    <div class="flex items-center justify-center">
                                        <input id="default-checkbox" type="checkbox" name="deletedAuthors[]"
                                            value="{{ $author->id }}" class="w-4 h-4  border-black rounded">
                                    </div>
                                </td>
                                <td class="p-3 w-20">
                                ...
                                <td class="p-3 w-46">
                                    {{ Carbon\Carbon::createFromTimestamp(strtotime($author->updated_at))->format('Y-m-d') }}
                                </td>
                            </tr>
                        @endforeach
                        @else
