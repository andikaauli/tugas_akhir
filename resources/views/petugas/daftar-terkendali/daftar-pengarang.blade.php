 ...
 <div class="sm:ml-64">
    <div class="mt-18">
     ...
     <div class="px-4 pt-4 flex justify-between my-5">
        ...
        <div>
            <a href="/create-pengarang" class="rounded px-3 py-2 text-white text-sm font-bold bg-gray-500 hover:bg-blue-500 mr-2">Tambah Pengarang Baru</a>
        </div>
   </div>
     {{-- End Section 1 --}}
     {{-- Section 2 --}}
     <div class="py-8 px-4 mb-4">
        ...
        <div class="flex items-center">
            <p class="mr-3">Cari</p>
            <form class="m-0" action="{{ route('client.authors') }}" method="GET">
                <div class="flex items-center">
           ...
           <table class="table-auto w-full">
              <thead class="p-3 border-y border-solid border-gray-400">
                 <tr class="text-sm">
                    ...
                    <th class="text-left p-3">NAMA PENGARANG</th>
                    <th class="text-left p-3">TAHUN LAHIR PENGARANG</th>
                ...
                <tr class="border-b border-solid border-gray-400">
                   <td class="p-3 w-16">
                      <div class="flex items-center justify-center">
                         <input id="default-checkbox" type="checkbox"  name="deletedAuthors[]" value="{{$author->id}}" class="w-4 h-4  border-black rounded">
                     </div>
                   </td>
                   <td class="p-3 w-20">
                      <a href="{{ route('client.edit-authors', ['id' => $author->id]) }}" class="flex items-center justify-center">
                   ...
                   <td class="p-3 w-52">1990</td>
                   <td class="p-3 w-46">{{$author->updated_at}}</td>
                </tr>
                @endforeach
              </tbody>
           </table>
