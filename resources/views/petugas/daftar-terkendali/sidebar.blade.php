    ...
    <div class="h-full pb-4 overflow-y-auto bg-blue-500">
     ...
     <div class="">
        ...
        <ul class="space-y-2 pl-1 font-bold text-sm">
           <li class=" ">
              <a href="/publisher" class="flex items-center p-2 text-white rounded-l-full hover:bg-white hover:bg-opacity-20 group @yield('active-penerbit')">
                 <span class="flex-1 ml-3 whitespace-nowrap">Penerbit</span>
              </a>
           </li>
           <li>
              <a href="/author" class="flex items-center p-2 text-white rounded-l-full hover:bg-white hover:bg-opacity-20 group @yield('active-pengarang')">
     ...
     <div class="">
        ...
        <ul class="space-y-2 pl-1 font-bold text-sm">
           <li>
              <a href="/colltype" class="flex items-center p-2 text-white rounded-l-full hover:bg-white hover:bg-opacity-20 group @yield('active-tipeKoleksi')">
