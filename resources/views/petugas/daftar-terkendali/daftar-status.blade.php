           ...
           <table class="table-auto w-full">
              <thead class="p-3 border-y border-solid border-gray-400">
                 <tr class="text-sm">
                    ...
                    <th class="text-left p-3">KODE STATUS EKSEMPLAR</th>
                    <th class="text-left p-3">NAMA STATUS EKSEMPLAR</th>
              ...
              <tbody>
                 <tr class="border-b border-solid border-gray-400">
                    ...
                    <td class="p-3 w-20">
                       <a href="/edit-status" class="flex items-center justify-center">
