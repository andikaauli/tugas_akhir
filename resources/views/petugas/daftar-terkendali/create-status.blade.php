 ...
 <div class="sm:ml-64">
    ...
    {{-- Section 2 --}}
       <div class="bg-white">
        ...
        {{-- End Kode Status Eksemplar --}}
        {{-- Nama Status Eksemplar* --}}
        <div class="flex border-y border-solid border-gray-300">
            <div class="px-4 py-3 text-sm w-60">
                <p class="font-bold text-sm">Nama Status Eksemplar*</p>
            </div>
            <div class="px-4 py-3 text-sm">
                <p class="font-bold text-sm">:</p>
            </div>
