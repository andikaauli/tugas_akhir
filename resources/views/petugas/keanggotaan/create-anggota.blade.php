         ...
         {{-- Nama Anggota --}}
             <div class="flex border-b border-solid border-gray-300">
                 ...
                 <div class="px-4 py-3 items-stretch flex-auto">
                     <input type="text" name="name" id="small-input" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
                 </div>
             </div>
         {{-- End Nama Anggota --}}
         {{-- NIM Anggota --}}
            <div class="flex border-y border-solid border-gray-300">
                ...
                <div class="px-4 py-3">
                    <input type="text" name="nim" id="small-input" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
                </div>
            </div>
        {{-- End NIM Anggota --}}
         {{-- Tanggal Lahir --}}
             <div class="flex border-b border-solid border-gray-300">
                 ...
                 <div class="px-4 py-3">
                     <input  class="px-2 py-1.5 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300" type="date" name="birth_date" id="dateofbirth">
                 </div>
             </div>
         {{-- End Tanggal Lahir --}}
         {{-- Institusi --}}
         ...
         <div class="flex border-b border-solid border-gray-300">
             ...
             <div class="flex flex-auto items-stretch px-4 py-3">
                 <textarea type="text" name="address"  class="flex-auto py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300" name="" id="" cols="30" rows="2"></textarea>
             </div>
         </div>
         {{-- End Alamat --}}
         {{-- Nomor Telepon --}}
         <div class="flex border-b border-solid border-gray-300">
             ...
             <div class="px-4 py-3">
                 <input type="text" name="phone" id="small-input" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
             </div>
         </div>
         {{-- End Nomor Telepon --}}
         {{-- Foto --}}
         ...
         <div class="flex border-b border-solid border-gray-300">
             ...
             <div class="px-4 py-3">
                 <input type="text" name="email" id="small-input" class="w-96 py-1 px-2 text-gray-900 border rounded text-sm border-solid border-gray-400 focus:ring focus:ring-blue-300">
             </div>
         </div>
         {{-- End Surel --}}
         {{-- Btn Simpan --}}
