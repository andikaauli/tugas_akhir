                   ...
                   <tbody>
                    ...
                    <tr class="border-b border-solid border-gray-400">
                       ...
                       <td class="p-3 w-20">
                          ...
                          <a href="{{ route('client.edit-member', [encrypt($member->id)]) }}" class="flex items-center justify-center">
                                  ...
                                  <div class="flex items-center">
                                    @if(isset($member->phone))
                                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <p class="font-medium ml-1">{{$member->phone}}</p>
                                    @else
                                        <p class="font-medium ml-1"></p>
                                    @endif
